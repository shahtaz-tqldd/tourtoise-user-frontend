...
const SearchPage = () => {
  ...
  const trips = useMemo(
    () => tripData?.pages?.flatMap((page) => page?.data) || [],
    [tripData],
  );
  ...
  return (
    <Container>
      <ListingHeader
        title="Search"
        description="Search destinations, trips, and journals"
      />

      <form className="relative mt-4 w-full md:hidden" onSubmit={submitSearch}>
