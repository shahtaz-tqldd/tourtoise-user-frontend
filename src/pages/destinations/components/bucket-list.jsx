...
import { useAutogeneratedMessageQuery } from "@/features/destination/destinationApiSlice";
...
export const BucketListPanel = ({
  ...
  const { data } = useAutogeneratedMessageQuery();
  const messageContent =
    data?.data?.message ||
    "Not sure where to start? Let me help you find your next destination to make a trip, shoot your queries!";
  return (
    <aside className={`min-w-0 lg:sticky lg:top-24 lg:self-start ${className}`}>
      <div className="space-y-12">
        <AgentMessageComposer message={messageContent} />
